...
export type returnProgram = { 
    program: WebGLProgram, 
    attributes: Object, 
    uniforms: Object
};

export function createProgram(gl: WebGL2RenderingContext, shaders: Array<WebGLShader>): returnProgram {
    ...
    let addToObject = (object: Object, path: string, value: WebGLUniformLocation): void => {
...
export function buildPrograms(gl: WebGL2RenderingContext, shaders: any): Object {
    const programs = {};
...
export function configureAttribute(gl: WebGL2RenderingContext, {
    location, count, type,
    normalize = false,
    stride = 0, offset = 0,
    divisor = 0,
...
export function createSampler(gl: WebGL2RenderingContext, {
