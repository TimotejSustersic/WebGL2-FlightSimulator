...
import { hideHTML, showHTML } from "./core/Utillity.js";
export var GameDTO;
(function (GameDTO) {
    GameDTO["Particle"] = "Particle";
    GameDTO["Circle"] = "Circle";
})(GameDTO || (GameDTO = {}));
export class Game {
    constructor(scene, document, interactionNodeName) {
        this.started = false;
        this.circles = [];
        this.difficulty = 4;
        this.scene = scene;
    ...
    createCircle(name, nodeDistance) {
        ...
        // add Location
        const circleTransform = circleInstance.getComponentOfType(Transform);
