...
import { getLocalModelMatrix, getGlobalViewMatrix, getProjectionMatrix, getModels, getGlobalModelMatrix, } from '../core/SceneUtils.js';
...
export class Renderer extends BaseRenderer {
    ...
    render(scene, camera, light) {
        ...
        gl.uniform3fv(uniforms.uLightColor, vec3.scale(vec3.create(), lightComponent.color, lightComponent.intensity / 255));
