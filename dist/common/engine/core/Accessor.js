export class Accessor {
    constructor({ buffer, viewLength, viewOffset = 0, offset = 0, stride, componentType = 'int', componentCount = 1, componentSize = 1, componentSigned = false, componentNormalized = false, }) {
        this.buffer = buffer;
        this.offset = offset;
        this.stride = componentSize;
    ...
    getNormalizer({ componentType, componentSize, componentSigned, componentNormalized, }) {
    ...
    getDenormalizer({ componentType, componentSize, componentSigned, componentNormalized, }) {
        if (!componentNormalized || componentType === 'float') {
            return x => x;
        }
        const multiplier = componentSigned
