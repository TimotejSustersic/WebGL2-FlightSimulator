...
export class Camera {
    constructor({ orthographic = 0, aspect = 1, fovy = 1, halfy = 1, near = 0.1, far = 1000, } = {}) {
    ...
    get projectionMatrix() {
        if (this.orthographic === 0) {
            ...
            return mat4.add(mat4.create(), mat4.multiplyScalar(a, a, this.orthographic), mat4.multiplyScalar(b, b, 1 - this.orthographic));
        }
    }
